...
var as = ['laydate_box', 'laydate_void', 'laydate_click', 'LayDateSkin', 'skins/', '../../laydate.css'/*tpa=http://www.youxiaoyouda.com/laydate.css*/];
...
Dates.festival = function(td, md){
    ...
    switch(md){
        ...
        case '6.1':
            str = '儿童';
        break;
        case '9.10.htm'/*tpa=http://www.youxiaoyouda.com/assets/js/9.10*/:
            str = '教师';
        break;
        case '10.1':
            str = '国庆';
